...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "I found this useful meeting time zone planner tool, check it out: https://seosaurus.in/tools/meeting-time-zone-planner/"
  );

  const toolUrl = "https://seosaurus.in/tools/meeting-time-zone-planner/";
